package net.masonapps.modelviewervr.math;

import com.badlogic.gdx.math.Plane;
import com.badlogic.gdx.math.Vector3;
import com.badlogic.gdx.math.collision.Ray;

import net.masonapps.vrsculpttool.mesh.Vertex;
...
public class SculptUtils {
    ...
    public static void setPlaneFromVertices(List<Vertex> vertexList, Plane plane) {
        normal.set(0, 0, 0);
        int n = 0;
        for (Vertex v : vertexList) {
            point.add(v.position);
