...
public class VirtualStage extends Stage implements VrInputProcessor {
    ...
    private Plane intersectionPlane = new Plane(Vector3.Z, 0);
...
//        intersectionPlane.set(translation, normal);
//
//        updated = true;
//
//        Pools.free(normal);
...
//        if (Intersector.intersectRayPlane(tmpRay, intersectionPlane, hitPoint3D)) {
//            PlaneUtils.toSubSpace(intersectionPlane, tmp.set(hitPoint3D).sub(translation), hitPoint2DPixels);
////            PlaneUtils.toSubSpace(intersectionPlane, hitPoint3D, hitPoint2DPixels);
...
//            return false;
        if (Intersector.intersectRayPlane(ray, intersectionPlane, hitPoint3D)) {
            tmp2.set(hitPoint3D).sub(tmp);
            PlaneUtils.toSubSpace(intersectionPlane, tmp2, tmpV2);
